...
<div class="title">Experimental Results of Concurrent Learning Adaptive Controller</div>
<div class="authors">Girish Chowdhary, Tongbin Wu, <b>Mark Cutler</b>, N. Kemal Ure, Jonathan P. How</div>
<div class="location_info">AIAA Guidance, Navigation, and Control Conference, August 2012, Minneapolis, MN, pp. 1-14
  <button data-dialog="Chowdhary12_GNC2_bib" class="button icon"><span class="fa-stack fa-lg">
<i class="fa fa-square-o fa-stack-2x"></i>
<i class="fa fa-quote-left fa-stack-1x"></i>
</span></button>
  <a href="http://acl.mit.edu/papers/chow_GNC12_conc_applications.pdf" target="_blank" class="button icon"><span class="fa-stack fa-lg">
<i class="fa fa-square-o fa-stack-2x"></i>
